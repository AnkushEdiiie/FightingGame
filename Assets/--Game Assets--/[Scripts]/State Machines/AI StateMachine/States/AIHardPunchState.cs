...
public class AIHardPunchState : AIState
{
    private bool changingStateCoroutineRunning = false;
    public AIHardPunchState(AI_StateHandler AI, AIStateMachine stateMachine, AIData enemyData) : base(AI, stateMachine, enemyData)
    {
    }
    ...
    {
        base.Enter();
        AI.AiAnim.SetTrigger("hardPunch");
