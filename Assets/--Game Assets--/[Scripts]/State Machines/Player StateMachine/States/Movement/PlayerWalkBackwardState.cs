...
public class PlayerWalkBackwardState : PlayerState
{
    public PlayerWalkBackwardState(StateHandler stateHandler, StateMachine stateMachine, InputReader inputReader, AnimationController animationController) : base(stateHandler, stateMachine, inputReader, animationController)
    {
    }
    ...
    {
        base.Enter();
        _animationController.animator.SetBool("Walk Backward", true);
    }

    public override void Exit()
    {
        base.Exit();
        _animationController.animator.SetBool("Walk Backward", false);
    }
    ...
    public override void LogicUpdate()
    {
        ...
        else if (_inputReader._inputReaderHolder.walkBackward == false)
            _stateMachine.ChangeState(_stateHandler._idleState);

        else if (_inputReader._inputReaderHolder.jumpBackward)
            _stateMachine.ChangeState(_stateHandler._jumpBackwardState);
    }
